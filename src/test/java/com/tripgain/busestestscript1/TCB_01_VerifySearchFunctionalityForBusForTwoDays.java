...
public class TCB_01_VerifySearchFunctionalityForBusForTwoDays extends BaseClass {
	WebDriver driver;    
	...
	public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
		...
		try{
			...
			List<String> filtersToClickDepart= Arrays.asList("Before 6 AM","6 AM to 12 PM","12 PM to 6 PM","After 6 PM");
			List<String> clickedDepartTime = tripgainresult.clickOnDepartTime(filtersToClickDepart);
			tripgainresult.ValidateDepartTime(filtersToClickDepart,Log, screenShots);
