...
public class TCH_06_VerifySearchFunctionalityForHotalApplyingFliters extends BaseClass {
	...
	public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
		...
		try{
			...
			Thread.sleep(3000);
			//search by locations
			resultpage.SearchByHotelClearAndSearch("BTM");
			resultpage.validateHotelAddress("BTM",Log, screenShots);
